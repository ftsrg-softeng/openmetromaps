...
public class PredicateEvaluatorRectangle extends AbstractPredicateEvaluator {
   ...
   public PredicateEvaluatorRectangle(double minX, double minY, double maxX, double maxY) {
      this.minX = minX;
      this.maxX = maxX;
      this.minY = minY;
      this.maxY = maxY;
   ...
   public boolean covers(Envelope env) {
      return env.getMinX() >= this.minX && env.getMaxX() <= this.maxX && env.getMinY() >= this.minY && env.getMaxY() <= this.maxY;
   }
   ...
   public boolean intersects(Envelope env) {
      return env.getMinX() <= this.maxX && env.getMaxX() >= this.minX && env.getMinY() <= this.maxY && env.getMaxY() >= this.minY;
   }
