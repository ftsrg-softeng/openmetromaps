...
public class SimpleNodeTreeDistributorFactory implements NodeTreeDistributorFactory {
   @Override
   public NodeTreeDistributor createDistributor(DataTree tree, Node head, OsmIterator iterator, DataTreeOutputFactory outputFactory) {
      return new SimpleNodeTreeDistributor(tree, head, iterator, outputFactory);
   }
}
